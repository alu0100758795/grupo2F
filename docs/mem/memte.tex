...
\HRule
\begin{center}
        {\Huge Integración Trapecio} \\[2.5mm] 
        {\Huge $f(x)=sen(\Pi x)$, $x \in [-2,-1]$} \\[2.5mm]
        {\Large  Lara Kristjansdottir, Javier Hernández Pérez} \\[5mm]
...
% ha puesto.
\markboth{Lara Kristjansdottir, Javier Hernández Pérez}{Integración Trapecio $f(x)=sen(\Pi x)$, $x \in [-2,-1]$}
